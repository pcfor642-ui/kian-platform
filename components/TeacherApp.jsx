...
import { GlassPanel, SectionTitle, StatRow, Drawer, TopHeader, PlaceholderPage, AccountCard, EmptyNote, logoutBtn } from "./ui";
...
export function TeacherApp({ user, onLogout, impersonating, dark, onToggleTheme }) {
  ...
  return (
    <div style={{ position: "relative", minHeight: 560, background: T.bg, fontFamily: FONT, overflow: "hidden" }}>
      <TopHeader onMenu={() => setDrawerOpen(true)} title="پنل معلم" dark={dark} onToggleTheme={onToggleTheme} />
